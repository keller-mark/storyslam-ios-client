...
class SSMyFinishedStories: SSContentView {
    ...
    override func setupViews() {
        ...
        self.lblTitle!.text = "Finished Stories"
    ...
    func loadFinishedStories() {
        ...
        if(currentUser != nil) {
            ...
            do {
                let opt = try HTTP.POST(StorySlam.actionURL + "getMyFinishedStories", parameters: ["username":currentUser!.username!, "token": currentUser!.token!])
                    ...
                    if(result["message"].string != nil) {
                        if(result["success"].boolValue == true) {
                            ...
                            dispatch_async(dispatch_get_main_queue(), {
                                ...
                                for (index,subJson):(String, JSON) in result["data"]["my_finished_stories"] {
