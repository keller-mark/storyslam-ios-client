...
class SSStorySlamFeedView: SSContentView {
    ...
    override func setupViews() {
        ...
        self.scrollView!.backgroundColor = StorySlam.colorLightGray
        
        self.lblTitle = UILabel()
        self.lblTitle!.text = "StorySlam Feed"
    ...
    func loadFinishedStories() {
        ...
        if(currentUser != nil) {
            ...
            do {
                let opt = try HTTP.POST(StorySlam.actionURL + "getAllFinishedStories", parameters: ["username":currentUser!.username!, "token": currentUser!.token!])
                    ...
                    if(result["message"].string != nil) {
                        if(result["success"].boolValue == true) {
                            ...
                            dispatch_async(dispatch_get_main_queue(), {
                                ...
                                for (index,subJson):(String, JSON) in result["data"]["all_finished_stories"] {
